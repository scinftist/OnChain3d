...
contract PlatonicReborn {
    ...
    function inital_array() public {
        ...
        num2solid[1].color_list.push(15158332);
        num2solid[1].color_list.push(10181046);
        num2solid[1].color_list.push(2600544);
        num2solid[1].color_list.push(2719929);
        num2solid[1].color_list.push(1752220);
        num2solid[1].color_list.push(16101441);
        // num2solid[0].color_list.push([51, 0, 153]);
        // num2solid[0].color_list.push([153, 0, 153]);
        ////
        num2solid[1].wire_color = 16737945;
